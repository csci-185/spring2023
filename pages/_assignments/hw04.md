...
<a href="/spring2023/course-files/homework/hw04.zip" class="nu-button">Homework 1 Starter Files <i class="fas fa-download"></i></a>
...
<img class="large frame" src="/spring2023/assets/images/homework/hw04/01-header.png" />
...
<img class="large frame" src="/spring2023/assets/images/homework/hw04/02-about.png" />
...
<img class="large frame" src="/spring2023/assets/images/homework/hw04/03-projects.png" />
...
<img class="large frame" src="/spring2023/assets/images/homework/hw04/04-contact.png" />
...
* Create a link to from your homepage (which you created during Tutorial 3) to the `index.html` you just made (which should be stored in the `homework/hw04` folder). Recall that your homepage is at the root of your `csci185` folder. 
...
1. A link to your **homepage** (from Tutorial 3) on GitHub pages, which should link to your hw04 assignment (and previous tutorials and classwork you have done).
