...
> **Assumptions:** This tutorial assumes that you have reviewed the materials assigned in [lecture 2](/spring2023/lectures/lecture-02).
...
<a href="/spring2023/course-files/tutorials/tutorial01.zip" class="nu-button">Download Tutorial Files <i class="fas fa-download"></i></a> <a href="/spring2023/course-files/tutorials/tutorial01_answers.zip" class="button">Solutions <i class="fas fa-download"></i></a>
